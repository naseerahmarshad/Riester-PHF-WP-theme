<?php
/**
 * Block template file: template-parts/blocks/icon-content-callout.php
 *
 * Icon Content Callout Block Template.
 *
...
$id = 'icon-content-callout-' . $block['id'];
if ( ! empty($block['anchor'] ) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$classes = 'block-icon-content-callout';
      ...
      <div class="flex">
        ...
        <div class="w-full ">
          ...
          <div class="relative flex  justify-center">
            ...
            <div class="content-section-wrapper flex flex-col gap-6 justify-center">
